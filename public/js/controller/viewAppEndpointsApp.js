var viewAppEndpointsApp = angular.module('viewAppEndpointsApp', []);

viewAppEndpointsApp.controller('mainController', function($scope, $http, $interval,$rootScope){

    $scope.endpoints='';
    $scope.manipulateApi='';
    $scope.setEditApi= '';

    $http.get("/ngViewAppEndpoints")
